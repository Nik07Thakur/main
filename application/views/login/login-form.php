...
<body class="">
  <div class="wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-4">
            <form id="LoginValidation" action="<?php echo base_url('login'); ?>" method="post" novalidate="novalidate">
            <div class="card ">
                ...
                <button type="submit" name="login-form" class="btn btn-rose">Login</button>
                </div>
            </div>
            </form>
        </div>
  ...
  <!--  Google Maps Plugin    -->
  <!-- <script src="https://maps.googleapis.com/maps/apiassets/js?key=YOUR_KEY_HERE"></script> -->
  <!-- Chartist JS -->
  ...
  <script>
    $(document).ready(function() {
      ...
      if(window.location.pathname == "/insurance/customers") {
        $('.nav-item').removeClass('active');
        $('.nav-item.customers').addClass('active');  
      }
      if(window.location.pathname == "/insurance/agents") {
        $('.nav-item').removeClass('active');
        $('.nav-item.agents').addClass('active');
      }
      $('.datatable').DataTable({
        "pageLength": 5
      });
